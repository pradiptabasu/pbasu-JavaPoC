 ...
 */
            ...
            /**
            *  EnumTimePeriods bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EnumTimePeriods
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":EnumTimePeriods",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "EnumTimePeriods",
    ...
    public static class Factory{
        ...
        */
        public static EnumTimePeriods parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EnumTimePeriods object =
                new EnumTimePeriods();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EnumTimePeriods".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EnumTimePeriods)com.hyperion.hsf.hsfwebservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

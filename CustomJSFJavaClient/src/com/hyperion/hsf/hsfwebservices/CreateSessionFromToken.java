 ...
 */
            ...
            /**
            *  CreateSessionFromToken bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CreateSessionFromToken
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CreateSessionFromToken",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CreateSessionFromToken",
    ...
    public static class Factory{
        ...
        */
        public static CreateSessionFromToken parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CreateSessionFromToken object =
                new CreateSessionFromToken();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CreateSessionFromToken".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CreateSessionFromToken)com.hyperion.hsf.hsfwebservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://hyperion.com/hsf/hsfwebservices/","token").equals(reader.getName()) || new javax.xml.namespace.QName("","token").equals(reader.getName()) ){

 ...
 */
            ...
            /**
            *  EnumCubes bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EnumCubes
    ...
    public static class Factory{
        ...
        */
        public static EnumCubes parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EnumCubes object =
                new EnumCubes();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EnumCubes".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EnumCubes)com.hyperion.hsf.hsfwebservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

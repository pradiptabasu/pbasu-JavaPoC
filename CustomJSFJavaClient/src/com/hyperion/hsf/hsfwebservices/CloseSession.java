 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static CloseSession parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CloseSession object =
                new CloseSession();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CloseSession".equals(type)){
                                ...
                                return (CloseSession)com.hyperion.hsf.hsfwebservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

 ...
 */
            ...
            /**
            *  EnumServers bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EnumServers
    ...
    public static class Factory{
        ...
        */
        public static EnumServers parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EnumServers object =
                new EnumServers();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EnumServers".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EnumServers)com.hyperion.hsf.hsfwebservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

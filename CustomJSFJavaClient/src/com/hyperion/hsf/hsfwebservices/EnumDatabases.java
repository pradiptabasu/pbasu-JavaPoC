 ...
 */
            ...
            /**
            *  EnumDatabases bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EnumDatabases
    ...
    public static class Factory{
        ...
        */
        public static EnumDatabases parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EnumDatabases object =
                new EnumDatabases();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EnumDatabases".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EnumDatabases)com.hyperion.hsf.hsfwebservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

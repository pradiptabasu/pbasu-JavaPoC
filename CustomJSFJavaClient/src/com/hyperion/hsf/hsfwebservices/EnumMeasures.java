 ...
 */
            ...
            /**
            *  EnumMeasures bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EnumMeasures
    ...
    public static class Factory{
        ...
        */
        public static EnumMeasures parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EnumMeasures object =
                new EnumMeasures();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EnumMeasures".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EnumMeasures)com.hyperion.hsf.hsfwebservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

 ...
 */
            ...
            /**
            *  ReleaseEntityLock bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ReleaseEntityLock
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ReleaseEntityLock",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ReleaseEntityLock",
    ...
    public static class Factory{
        ...
        */
        public static ReleaseEntityLock parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReleaseEntityLock object =
                new ReleaseEntityLock();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ReleaseEntityLock".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ReleaseEntityLock)com.hyperion.hsf.hsfwebservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

 ...
 */
            ...
            /**
            *  EnumOpenedEntities bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EnumOpenedEntities
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":EnumOpenedEntities",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "EnumOpenedEntities",
    ...
    public static class Factory{
        ...
        */
        public static EnumOpenedEntities parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EnumOpenedEntities object =
                new EnumOpenedEntities();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EnumOpenedEntities".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EnumOpenedEntities)com.hyperion.hsf.hsfwebservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

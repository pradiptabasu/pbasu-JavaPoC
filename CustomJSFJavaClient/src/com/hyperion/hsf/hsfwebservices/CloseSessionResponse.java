 ...
 */
            ...
            /**
            *  CloseSessionResponse bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CloseSessionResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CloseSessionResponse",
    ...
    public static class Factory{
        ...
        */
        public static CloseSessionResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CloseSessionResponse object =
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CloseSessionResponse".equals(type)){
                                ...
                                return (CloseSessionResponse)com.hyperion.hsf.hsfwebservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

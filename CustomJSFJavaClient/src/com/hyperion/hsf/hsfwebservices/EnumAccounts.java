 ...
 */
            ...
            /**
            *  EnumAccounts bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EnumAccounts
    ...
    public static class Factory{
        ...
        */
        public static EnumAccounts parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EnumAccounts object =
                new EnumAccounts();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EnumAccounts".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EnumAccounts)com.hyperion.hsf.hsfwebservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

 ...
 */
            ...
            /**
            *  GetEntityLockInfo bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetEntityLockInfo
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetEntityLockInfo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetEntityLockInfo",
    ...
    public static class Factory{
        ...
        */
        public static GetEntityLockInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetEntityLockInfo object =
                new GetEntityLockInfo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetEntityLockInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetEntityLockInfo)com.hyperion.hsf.hsfwebservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
